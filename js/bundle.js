...
function calc() {
  ...
  var getStaticInfo = function getStaticInfo(parentSelector, activeClass) {
  ...
  var getDynamicInfo = function getDynamicInfo(selector) {
    var input = document.querySelector(selector);
    localStorage.getItem(input.getAttribute('id')) == 0 ? input.value = '' : input.value = localStorage.getItem(input.getAttribute('id'));
...
function cards() {
  ...
  var MenuCard = /*#__PURE__*/function () {
    function MenuCard(img, alt, header, text, price, parentSelector) {
...
function forms(formSelector, modalSelector, modalTimerId) {
  ...
  function bindPostData(form) {
    form.addEventListener('submit', function (e) {
      ...
      axios.post('http://localhost:3000/requests', obj).then(function (response) {
  ...
  function showThanksModal(msg) {
    ...
    (0,_modal__WEBPACK_IMPORTED_MODULE_7__.openModal)(modalSelector, modalTimerId);
    ...
    setTimeout(function () {
      ...
      (0,_modal__WEBPACK_IMPORTED_MODULE_7__.closeModal)(modalSelector);
    }, 4000);
  }
}
...
function modal(modalSelector, modalBtnSelector, modalTimerId) {
  var modalBtns = document.querySelectorAll(modalBtnSelector),
      modal = document.querySelector(modalSelector),
      showModalByScroll = function showModalByScroll() {
...
function slider(_ref) {
  ...
  var slideIndex = Math.floor(1 + Math.random() * slides.length);
  slidesField.style.width = 100 * slides.length + '%';
  slidesField.style.display = 'flex';
  slidesField.style.transition = '0.5s all';
  slidesWrapper.style.overflow = 'hidden';
  var dotsField = document.createElement('ol'); // create indicators field
  ...
  slides.forEach(function (slide) {
    ...
    var dot = document.createElement('li'); // create indicators
  ...
  var moveSlide = function moveSlide() {
    ...
    dots.forEach(function (dot, i) {
      return i === slideIndex - 1 ? dot.style.opacity = 1 : dot.style.opacity = 0.5;
    });
    slidesField.style.transform = "translateX(".concat(0 - 100 / slides.length * (slideIndex - 1), "%)");
  };
...
/***/ "./node_modules/dom-node-polyfills/index.js":
/*!**************************************************!*\
  !*** ./node_modules/dom-node-polyfills/index.js ***!
  \**************************************************/
/***/ (function() {
...
function after() {
    var e = Array.prototype.slice.call(arguments), r = document.createDocumentFragment()
    e.forEach(function (e) {
        var t = e instanceof Node
...
[Element.prototype, Document.prototype, DocumentFragment.prototype].forEach(function (e) {
    ...
    if (!e.replaceWith) e.replaceWith = replaceWith
})
...
/*!**********************!*\
  ...
  \**********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var dom_node_polyfills__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! dom-node-polyfills */ "./node_modules/dom-node-polyfills/index.js");
/* harmony import */ var dom_node_polyfills__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(dom_node_polyfills__WEBPACK_IMPORTED_MODULE_0__);
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_3__["default"])('.timer', deadline);
  (0,_modules_cards__WEBPACK_IMPORTED_MODULE_4__["default"])();
  (0,_modules_calc__WEBPACK_IMPORTED_MODULE_5__["default"])();
  (0,_modules_forms__WEBPACK_IMPORTED_MODULE_6__["default"])('form', '.modal', modalTimerId);
